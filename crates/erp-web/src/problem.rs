...
const TYPE_PREFIX: &str = "https://errors.erp.example/";

#[derive(Debug, Clone, serde::Serialize, utoipa::ToSchema)]
#[schema(example = json!({
    "type": "https://errors.erp.example/auth.invalid_credentials",
    "title": "Unauthorized",
    "status": 401,
    "code": "auth.invalid_credentials",
...
pub struct Problem {
    /// `https://errors.erp.example/` followed by the code. Stable, and a place
    ...
    pub args: std::collections::BTreeMap<String, erp_i18n::MessageArg>,
}
