...
//! made about ZATCA, and from `payments`'s own copy. Not shared as a crate: it
//! is fifty lines, and a test helper that grows a dependency edge between three
//! modules costs more than it saves.
