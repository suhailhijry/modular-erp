...
use spa_types::{EventName, LogPosition, SchemaVersion, Sequence, StreamId};
...
impl spa_i18n::Localize for AppendError {
    fn message(&self) -> spa_i18n::Message {
        match self {
            ...
            Self::Conflict { .. } => spa_i18n::Message::new(messages::CONCURRENT_MODIFICATION),
            Self::Empty | Self::Database(_) => spa_i18n::Message::new(messages::INTERNAL),
        }
    }
}
