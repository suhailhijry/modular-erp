...
use spa_control::mail::{Email, email_kind};
use spa_eventlog::{DeliveryError, EffectHandler, PendingEffect};
...
impl Mailer for Smtp {
    async fn send(&self, email: &Email, key: &str) -> Result<(), MailError> {
        ...
        let message = lettre::Message::builder()
            ...
            .message_id(Some(format!("<{key}@spa>")))
...
mod tests {
    ...
    fn an_email() -> Email {
        Email {
            ...
            body: "افتح هذا الرابط:\nhttps://acme.spa.test/v1/join/xyz".to_owned(),
