...
- [Words this system uses](./words.md)
- [Why it is built this way](./decisions.md)
- [The eight laws](./laws.md)
- [What the modules do](./modules.md)

# The code

- [How the crates fit together](./crates.md)
- [The write path](./writing.md)
- [The read path](./reading.md)
- [Building read models](./projecting.md)
- [Effects and the worker](./effects.md)
- [Writing a module](./module.md)
- [How it is tested](./testing.md)

# Running it

- [Three ways to deploy](./deployment.md)
- [On your computer](./local.md)
- [Backup and restore](./restore.md)
- [Upgrades](./upgrades.md)

# API reference

- [Reading this reference](./api/index.md)
...
- [erp-web](./api/erp-web.md)
- [erp-worker](./api/erp-worker.md)
